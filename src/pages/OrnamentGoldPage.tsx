      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12}>
          <Stack direction={{ xs: "column", sm: "row" }} spacing={2} justifyContent="flex-end">
            ...
            <Button variant="outlined" startIcon={<PrintIcon />} onClick={() => print({ type: "ornament", firstname: form.firstname, lastname: form.lastname, idcard: form.idcard, phone: form.phone, address: form.address, weight: parseFloat(form.weight)||0, amount: parseFloat(form.amount)||0, goldType: mode === "buy" ? "ขายออก" : "ซื้อเข้า", remark: form.remark })}>
              พิมพ์ใบเสร็จ
            </Button>
